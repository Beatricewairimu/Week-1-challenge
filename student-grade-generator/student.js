...
function scoreEvaluator() {
    ...
    if (score < 0 || score > 100 || (!score)) {
      //The second or is for Not a number.
        ...
        //If the score is > than 79, it displays the grade "A"
  
        console.log("Grade: A");
  
      } else if (score >= 60) {
        //If the score is >=60, it displays the grade "B"
  
        console.log("Grade: B");
  
      } else if (score >= 49) {
        // If the score is >=49, it displays the grade "C"
  
        console.log("Grade: C");
  
      } else if (score >= 40) {
        // If the score is >=40, it displays the grade "D"
        ...
        console.log("Grade: E");
        //If the score is 39 and below, it displays the grade "E"
